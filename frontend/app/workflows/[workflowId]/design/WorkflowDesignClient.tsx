                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className={`flex items-start justify-between rounded-lg p-3 w-full text-left transition-colors group/card ${isActive
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2 ml-3">
                                                    <span
                                                        className={`text-xs font-medium px-2 py-1 rounded whitespace-nowrap ${isDone
                                                                    ...
                                                                    {availableKeys.map((key) => {
                                                                        ...
                                                                        return (
                                                                            <button
                                                                                ...
                                                                                className={`inline-flex items-center rounded-full border px-2 py-0.5 text-[10px] transition-colors ${selected
                            ...
                            <div className="flex items-center justify-between border-b border-[#282b39] bg-surface-darker px-4 py-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-mono text-sm font-medium text-white">
                                        {workflowName ? `Agent Output Stream - ${workflowName}` : "Agent Output Stream"}
                                    </span>
                                </div>
                                <div className="flex bg-[#282b39] rounded-lg p-1">
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-bold rounded ${activeTab === "preview"
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-medium rounded ${activeTab === "json"
                                                ? "bg-primary text-white shadow-sm"
                                                : "text-[#9da1b9] hover:text-white"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-medium rounded ${activeTab === "logs"
                                                ? "bg-primary text-white shadow-sm"
                                                : "text-[#9da1b9] hover:text-white"
                                            }`}
                                    >
                                                                ...
                                                                {sec.keys.map((key) => {
                                                                    ...
                                                                    return (
                                                                        <button
                                                                            ...
                                                                            className={`inline-flex items-center rounded-full border px-2 py-0.5 text-[10px] transition-colors ${isSelected
                                                                                    ? "border-primary bg-primary/10 text-primary"
                                                                                    : "border-[#3b3f54] bg-[#0f1116] text-[#d4d6e6] hover:border-primary/60 hover:text-primary"
                                                                                }`}
                                                                        >
                                                ...
                                                {selected.length === 0 ? (
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        {selected.map((key) => (
                                                            <div
                                                                key={key}
                                                                className={`flex items-center justify-between rounded-lg border border-[#282b39] bg-[#151722] px-3 py-2 ${draggingOutputKey === key ? "opacity-70" : ""
                                                                    }`}
                                                                draggable
                                                                onDragStart={(e) => {
